...
def home(request):
    ...
    if request.method == "POST":
        zipcode = request.POST['query']
        api_request = requests.get(f'http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode={zipcode}&distance=5&API_KEY=DC937C79-8B92-4099-B0A3-13226AAA32DA')
